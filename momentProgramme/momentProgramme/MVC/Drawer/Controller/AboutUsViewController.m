...
- (void)createAView{
    ...
    self.image.image = [UIImage imageNamed:@"Drawer_AboutUs"];
    ...
    self.contentLabel.text = @"      EosWing(厄俄斯的翅膀)是一款阅读故事和聆听电台的App，Eos是古希腊神话中带着翅膀的女神，传说里她每到一处，散发着清香的花瓣和玫瑰香水的水珠便坠落在地上成为露水。希望我们的应用也能为您带来露水般清新的体验与享受。\n      EosWing在此声明,您通过本软件参与的任何商业活动,与Apple Inc.无关\n      本软件资源取自互联网,如有侵权请联络反馈问题邮箱,我们将立即进行删除,感谢您的理解.";
